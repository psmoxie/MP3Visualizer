...
Player.prototype = {
  ...
  play: function(index) {
    ...
    // check to see if index is a number
  ...
  // Formatting time into format min:seconds and returns a string
  ...
  updateTimer: function() {
	...
	// format curently played of music into pure seconds and then convert that into a percentage for the progress bar
...
// setup SiRi wave object for the visualizer wave
